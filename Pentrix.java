...
public class Pentrix extends Applet {
    ...
    private final static Color PIECE_COLORS[] = {
            ...
            new Color(0x5539FF), // purple
            new Color(0x378BFF), // blue
            new Color(0x378BFF), // blue
    };
    ...
    private final static Color BACKGROUND_COLOR = new Color(0x5CB72F);
    ...
    private static boolean tmp_grid[][] = new boolean[5][5]; // scratch space
    ...
    private int next_piece_grid[][] = new int[5][5];
    ...
    private class TetrisPiece {
        ...
        private int type;
        private Point position = new Point(3, -5); // -4 to start above top row
    ...
    private class Timer extends Thread {
        ...
        public void setDelay(long delay) { m_delay = (int) (delay * .5); }
    ...
    private class GridCanvas extends DoubleBufferedCanvas {
        ...
        public Dimension getPreferredSize() {
            return new Dimension(grid[0].length * 35, grid.length * 35);
        }
    ...
    private void installNewPiece() {
        ...
        cur_piece.setPosition(3, -5); //-4 to start above top of grid
    ...
    public static void main(String[] args) {
        ...
        Frame frame = new Frame("Pentrix");
        Pentrix tetris = new Pentrix();
        frame.add(tetris);
        tetris.init();
        tetris.start();
